...
else
{
	...
	$result=mysqli_query($conn,"select * from questionSet WHERE `quesSetId`='$quesSetId'");
...
<div class="wrapper">
  ...
  <header class="main-header">
	...
	<h4 style="color:white; text-align:center;" class="col-sm-10 control-label">Assessment System for Education Institute</h4>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Questions Set</a></li>
        <li class="active">Create New Question Set</li>
      </ol>
    </section>
        ...
        <div>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Create New Question Set</h3>
            </div>
			...
			<form role="form" class="form-horizontal" action="update_question_logic.php" method="POST" autocomplete="off">
		
				<div class="tab-content" style="padding: 40px;">
				  <!-- Basic Info -->
				  <div class="tab-pane active" id="basicInfo">
				  
				  <input type="hidden" name="quesSetId" value="<?php echo $quesSetId; ?>">
					<div class="form-group">
					  <label for="quesSetName" class="col-sm-2 control-label">Ques Set Name:</label>
					  <div class="col-sm-10">
					...
					<div class="form-group hidden">
					  ...
					  <?php 
						...
						while($row=mysqli_fetch_assoc($result)) 
						{ 
							echo '<option value="'.$row["unitsId"].'" '.(($row["unitsId"]==$topicId)?'selected="selected"':"").'>'.$row["unitsName"].'</option>';
						} 
					  ?>
					  </select>
					  </div>
					...
					<div class="form-group">
					 ...
					 <input type="hidden" name="quesSetListDetail" id="quesSetListDetail" value="<?php echo $quesIdList; ?>">
					   <a id="buttonView" class="btn btn-primary">Next</a>

					 <!-- <input type="hidden" name="quesSetListdownload" id="quesSetListdownload" value="<?php //echo $quesIdList; ?>"> -->
					   <a id="buttonView"  href = "dowloadphp.php?varname=<?php echo $quesSetId;?>" target = "_blank" class="btn btn-secondary">Download QP</a>

				  </div>
				  <!-- Question List -->
				  <div class="tab-pane" id="questionsList">
					   <div id="txtHint"><b>Questions will be listed here...</b></div>
...
$('#buttonView').click(function() 
{
    ...
    var val6 = $('#status').val();
    var val7 = $('#quesSetListDetail').val();
 
    $.ajax({
        type: 'POST',
        url: 'get_questions_list_for_update.php',
        data: { text1: val1, text2: val2, text3: val3, text4: val4, text5: val5, text6: val6 , text7: val7},

...
else
{
	...
	{	
		...
		$numberOptions=$row['answerOptions'];
	...
	if(isset($_POST['submit']))//for update question
	{
		$questionID=$_POST['questionID'];
		$answerOptionId=$_POST['answerOptionId'];
		...
		$correctAnswerOption=$_POST['correctAnswerOption'];
		
		$result1=mysqli_query($conn,"UPDATE question set `complexityLevel`='$complexityLevel', `gradeId`='$gradeId', `gradeName`='$gradeName', `subjectId`='$subjectId', `subjectName`='$subjectName', `unitsId`='$unitsId', `unitsName`='$unitsName', `chapterId`='$chapterId', `chapterName`='$chapterName', `questionText`='$questionText', `addedOn`='$addedOn', `addedBy`='$addedBy', `status`='$status' WHERE `questionId`='$questionID'");
		if(mysqli_affected_rows($conn) > 0)
		{
			$dir="../../images/questions/XII/math/"."quesid_".$questionID;
			chdir ($dir);
			$path1 = "$root"."/backend/yofundowebapp/images/questions/XII/math/"."quesid_"."$questionID"."/";
			$upload_url1 = "http://"."34.229.183.41/backend/yofundowebapp/images/questions/XII/math/"."quesid_"."$questionID"."/";
			...
			{	
				...
				$result1 = move_uploaded_file($_FILES['questionPic']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$question_pic = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					
					$result2=mysqli_query($conn,"UPDATE `question` SET `questionPic`='$question_pic' WHERE `questionID`='$questionID'");
				}
			}
			...
			if(isset($_FILES['answerIcon1']))
			{
				...
				$result1 = move_uploaded_file($_FILES['answerIcon1']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_icon1 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt1Icon`='$answer_icon1' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerPic1']))
			{
				...
				$filename1="ap1";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path
				$result1 = move_uploaded_file($_FILES['answerPic1']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_pic1 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt1Pic`='$answer_pic1' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerIcon2']))
			{
				...
				$filename1="ai2";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path
				$result1 = move_uploaded_file($_FILES['answerIcon2']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_icon2 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt2Icon`='$answer_icon2' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerPic2']))
			{
				...
				$result1 = move_uploaded_file($_FILES['answerPic2']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_pic2 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt2Pic`='$answer_pic2' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerIcon3']))
			{
				...
				$result1 = move_uploaded_file($_FILES['answerIcon3']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_icon3 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt3Icon`='$answer_icon3' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerPic3']))
			{
				...
				$filename1="ap3";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path to upload 
				$result1 = move_uploaded_file($_FILES['answerPic3']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_pic3 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt3Pic`='$answer_pic3' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerIcon4']))
			{
				...
				$filename1="ai4";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path to
				$result1 = move_uploaded_file($_FILES['answerIcon4']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_icon4 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt4Icon`='$answer_icon4' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerPic4']))
			{
				...
				$filename1="ap4";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path to
				$result1 = move_uploaded_file($_FILES['answerPic4']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_pic4 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt4Pic`='$answer_pic4' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerIcon5']))
			{
				...
				$filename1="ai5";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path to
				$result1 = move_uploaded_file($_FILES['answerIcon5']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_icon5 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt5Icon`='$answer_icon5' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['answerPic5']))
			{
				...
				$filename1="ap5";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path to upload 
				$result1 = move_uploaded_file($_FILES['answerPic5']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$answer_pic5 = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `answer_options` SET `answerOpt5Pic`='$answer_pic5' WHERE `answerOptionId`='$answerOptionId'");
				}
			}
			...
			if(isset($_FILES['solutionImage']))
			{
				...
				$filename1="s1";
				$file_path1 = $path1 . $filename1 . '.'. $extension1; //file path to upload 
				$result1 = move_uploaded_file($_FILES['solutionImage']['tmp_name'],$file_path1);
				if($f1!= '')
				{
					$solution_image = $upload_url1 . $filename1 . '.' . $extension1;
					$flag++;
					$result2=mysqli_query($conn,"UPDATE `solution` SET `solutionPic`='$solution_image' WHERE `answerOptionId`='$answerOptionId'");
				}
			}		

			$result3=mysqli_query($conn,"UPDATE `answer_options` SET `answerOptions`='$numberOptions', `answerOptType`='$answerOptType', `answerOpt1Text`='$answerText1', `answerOpt2Text`='$answerText2', `answerOpt3Text`='$answerText3', `answerOpt4Text`='$answerText4', `answerOpt5Text`='$answerText5' WHERE `answerOptionId`='$answerOptionId'");
			echo "<script type='text/javascript'>
				window.location.href='http://34.229.183.41/backend/yofundowebapp/pages/questions/view_question.php';
...
function codeForPreview()
{
	var numberOptions = <?php echo "$numberOptions"; ?>;

	if(String(numberOptions) === String("1"))
	{
		$("#dvAnsOp1_1").show();
		
		$('#dvAnsOp1').css({'display':'block'});
		$('#dvAnsOp2').css({'display':'none'});
		$('#dvAnsOp3').css({'display':'none'});
		$('#dvAnsOp4').css({'display':'none'});
		$('#dvAnsOp5').css({'display':'none'});
		
		$('#removeQuestion1').css({'display':'block'});
		$('#addQuestion1').css({'display':'none'});
		$('#addQuestion2').css({'display':'block'});
	}
	else if(String(numberOptions) === String("2"))
	{
		$("#dvAnsOp1_1").show();
		$("#dvAnsOp2_1").show();
		
		$('#dvAnsOp1').css({'display':'block'});
		$('#dvAnsOp2').css({'display':'block'});
		$('#dvAnsOp3').css({'display':'none'});
		$('#dvAnsOp4').css({'display':'none'});
		$('#dvAnsOp5').css({'display':'none'});
		
		$('#removeQuestion1').css({'display':'block'});
		$('#removeQuestion2').css({'display':'block'});
		$('#addQuestion1').css({'display':'none'});
		$('#addQuestion2').css({'display':'none'});
		$('#addQuestion3').css({'display':'block'});
	}
	else if(String(numberOptions) === String("3"))
	{
		$("#dvAnsOp1_1").show();
		$("#dvAnsOp2_1").show();
		$("#dvAnsOp3_1").show();
		...
		$('#dvAnsOp1').css({'display':'block'});
		$('#dvAnsOp2').css({'display':'block'});
		$('#dvAnsOp3').css({'display':'block'});
		$('#dvAnsOp4').css({'display':'none'});
		$('#dvAnsOp5').css({'display':'none'});
		
		$('#removeQuestion1').css({'display':'block'});
		$('#removeQuestion2').css({'display':'block'});
		$('#removeQuestion3').css({'display':'block'});
		$('#addQuestion1').css({'display':'none'});
		$('#addQuestion2').css({'display':'none'});
		$('#addQuestion3').css({'display':'none'});
		$('#addQuestion4').css({'display':'block'});
	}
	else if(String(numberOptions) === String("4"))
	{
		$("#dvAnsOp1_1").show();
		$("#dvAnsOp2_1").show();
		$("#dvAnsOp3_1").show();
		...
		$('#dvAnsOp2').css({'display':'block'});
		$('#dvAnsOp3').css({'display':'block'});
		$('#dvAnsOp4').css({'display':'block'});
		$('#dvAnsOp5').css({'display':'none'});
		
		$('#removeQuestion1').css({'display':'block'});
		$('#removeQuestion2').css({'display':'block'});
		$('#removeQuestion3').css({'display':'block'});
		$('#removeQuestion4').css({'display':'block'});
		$('#addQuestion1').css({'display':'none'});
		$('#addQuestion2').css({'display':'none'});
		$('#addQuestion3').css({'display':'none'});
		$('#addQuestion4').css({'display':'none'});
		$('#addQuestion5').css({'display':'block'});
	}
	else if(String(numberOptions) === String("5"))
	{
		$("#dvAnsOp1_1").show();
		$("#dvAnsOp2_1").show();
		$("#dvAnsOp3_1").show();
	...
	var quesPicVar = '<?php echo "$questionPic"; ?>';
	if(String(quesPicVar) === String(""))
	{
		$('#outputQuestionPic').css({'display':'none'});
		$('#outputQuestionPic1').css({'display':'none'});
	}
	else
	{
		$('#outputQuestionPic').css({'display':'block'});
		$('#outputQuestionPic1').css({'display':'block'});
	}
	
	var solutionPicVar = '<?php echo "$solutionPic"; ?>';
	if(String(solutionPicVar) === String(""))
	{
		$('#outputSolutionImage').css({'display':'none'});
		$('#outputSolutionImage1').css({'display':'none'});
	}
	else
	{
		$('#outputSolutionImage').css({'display':'block'});
		$('#outputSolutionImage1').css({'display':'block'});
	}
}
</script>
		...
		<div class="box-header with-border">
          ...
          <div class="nav-tabs-custom">
			...
			<div class="tab-content" style="padding: 40px;">
			  ...
			  <!-- hidden -->
				<input type="hidden" class="form-control" name="questionID" id="questionID" value="<?php echo $questionID; ?>">
				
				<input type="hidden" class="form-control" name="answerOptionId" id="answerOptionId" value="<?php echo $answerOptionId; ?>">
				
				<input type="hidden" class="form-control" name="solutionId" id="solutionId" value="<?php echo $solutionId; ?>">
				<!--hidden-->
             ...
             <label for="gradeName" class="col-sm-2 control-label">Program name:</label>
                  ...
                  <?php 
					...
					{ 
						echo '<option value="'.$row["gradeId"].'" '.(($row["gradeId"]==$gradeId)?'selected="selected"':"").'>'.$row["gradeName"].'</option>';
					} 
				  ?>
				  </select>
				  </div>
                ...
                <label for="subjectName" class="col-sm-2 control-label">Course name:</label>
				  <div class="col-sm-10">
				  <select class="form-control select2" name="subjectName" id="subjectName" style="width: 100%;">
                  <option disabled>--Select--</option>
                  <?php 
					$result=mysqli_query($conn,'SELECT * FROM subject');
					while($row=mysqli_fetch_assoc($result)) 
					{ 
						echo '<option value="'.$row["subjectId"].'" '.(($row["subjectId"]==$subjectId)?'selected="selected"':"").'>'.$row["subjectName"].'</option>';
					} 
				  ?>
				  </select>
                  ...
                  <label for="chapterName" class="col-sm-2 control-label">Chapter Name:</label>
									  <div class="col-sm-10">
									  <select class="form-control select2" name="chapterName" id="chapterName" style="width: 100%;">
					                  <option selected="selected" disabled>--Select--</option>
					                  <?php 
										$result=mysqli_query($conn,'SELECT * FROM chapter');
										while($row=mysqli_fetch_assoc($result)) 
										{ 
											echo '<option value="'.$row["chapterId"].'" '.(($row["chapterId"]==$chapterId)?'selected="selected"':"").'>'.$row["chapterName"].'</option>';
										} 
									  ?>
									  </select>
									  </div>
                  ...
                  <label for="unitsName" class="col-sm-2 control-label">Units Name:</label>
									  <div class="col-sm-10">
									  <select class="form-control select2" name="unitsName" id="unitsName" style="width: 100%;">
					                  <option selected="selected" disabled>--Select--</option>
					                  <?php 
										$result=mysqli_query($conn,'SELECT * FROM subject_units');
										while($row=mysqli_fetch_assoc($result)) 
										{ 
											echo '<option value="'.$row["unitsId"].'" '.(($row["unitsId"]==$unitsId)?'selected="selected"':"").'>'.$row["unitsName"].'</option>';
										} 
									  ?>
									  </select>
			  ...
			  <div class="tab-pane" id="questionInfo">
				<div class="form-group">
				  ...
				  <div class="col-sm-10" style="margin-top: 5px;">
					  <input type="radio" name="complexityLevel" value="Simple" class="minimal" <?php echo (($complexityLevel=="Simple")?'checked':"");?>> Simple &nbsp;
					  <input type="radio" name="complexityLevel" value="Medium" class="minimal" <?php echo (($complexityLevel=="Medium")?'checked':"");?>> Medium &nbsp;
					  <input type="radio" name="complexityLevel" value="Complex" class="minimal" <?php echo (($complexityLevel=="Complex")?'checked':"");?>> Complex 
				  </div>
                </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  <textarea class="form-control" id="questionText" name="questionText" rows="10" cols="80" placeholder="Question text" required>
				...
				<div class="form-group">
				  ...
				  <img src='<?php echo "$questionPic";?>' class='myImg' id="outputQuestionPic" style="margin-top: 10px;" width='100' height='100'/>
			  ...
			  <div class="tab-pane" id="answerOption">	
				...
				<div class="form-group">
				  ...
				  <!-- radio -->
				  <div class="col-sm-10">
					  <input type="radio" name="answerOptions" id="icons_only" value="1" class="minimal" <?php echo (($answerOptType=="1")?'checked':"");?>>&nbsp;&nbsp; Icons only 
					  <br/><br/>
					  <input type="radio" name="answerOptions" id="text_only" value="2" class="minimal" <?php echo (($answerOptType=="2")?'checked':"");?>>&nbsp;&nbsp; Text only 
					  <br/><br/>
					  <input type="radio" name="answerOptions" id="icons_text" value="3" class="minimal" <?php echo (($answerOptType=="3")?'checked':"");?>>&nbsp;&nbsp; Icons + Text 
					  <br/><br/>
					  <input type="radio" name="answerOptions" id="pictures" value="4" class="minimal" <?php echo (($answerOptType=="4")?'checked':"");?>>&nbsp;&nbsp; Pictures 
					  <br/><br/>
					  <input type="radio" name="answerOptions" id="pictures_text" value="5" class="minimal" <?php echo (($answerOptType=="5")?'checked':"");?>>&nbsp;&nbsp; Pictures + Text
					  
					<div class="box-footer" align="right">
						<input type='text' id="addQuestion1" style="display: none"  class="btn btn-primary" style="padding: 0; border: none; background: none;color:blue;" value='+ ADD ANSWER OPTION' readonly>
					</div>
				  </div>				  
                </div>
				...
				Answer Option 1
					<div class="form-group" id="divAnswerText1" style='<?php echo "$answerOpText1";?>'>
					  <label for="answerText1" class="col-sm-2 control-label">Answer Text:</label>
					  <div class="col-sm-10">
					  <textarea class="form-control" id="answerText1" name="answerText1" rows="5" cols="80" placeholder="Answer text"><?php echo $answerOpt1Text; ?></textarea>	
				  
					  </div>
					</div>
					
					<!--Answer icon-->
					<div class="form-group" id="divAnswerIcon1" style='<?php echo "$answerOpIcon1";?>'>
					  ...
					  <img src='<?php echo "$answerOpt1Icon";?>' class='myImg' id="outputAnswerIcon1" style="margin-top: 10px;" width='100' height='100'/>
						<!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<!--Answer icon-->
					<div class="form-group" id="divAnswerPic1" style='<?php echo "$answerOpPic1";?>'>
					  ...
					  <img src='<?php echo "$answerOpt1Pic";?>' class='myImg' id="outputAnswerPic1" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<div class="box-footer" align="right">
						<input type='text' id="addQuestion2" style="display: none"  class="btn btn-primary" style="padding: 0; border: none; background: none;color:blue;" value='+ ADD ANSWER OPTION' readonly>
					</div>
				...
				Answer Option 2
					<div class="form-group" id="divAnswerText2" style='<?php echo "$answerOpText2";?>'>
					  <label for="answerText2" class="col-sm-2 control-label">Answer Text:</label>
					  <div class="col-sm-10">
					  <textarea class="form-control" id="answerText2" name="answerText2" rows="5" cols="80" placeholder="Answer text"><?php echo $answerOpt2Text; ?></textarea>	
					  </div>
					</div>
					
					<!--Answer icon-->
					<div class="form-group" id="divAnswerIcon2" style='<?php echo "$answerOpIcon2";?>'>
					  ...
					  <img src='<?php echo "$answerOpt2Icon";?>' class='myImg' id="outputAnswerIcon2" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<!--Answer icon-->
					<div class="form-group" id="divAnswerPic2" style='<?php echo "$answerOpPic2";?>'>
					  ...
					  <img src='<?php echo "$answerOpt2Pic";?>' class='myImg' id="outputAnswerPic2" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<div class="box-footer" align="right">
					<input type='text' id="addQuestion3" style="display: none"  class="btn btn-primary" style="padding: 0; border: none; background: none;color:blue;" value='+ ADD ANSWER OPTION' readonly>
				</div>
				</div>
				...
				<div class="box-footer" align="right">
					...
					Answer Option 3
					<div class="form-group" id="divAnswerText3" style='<?php echo "$answerOpText3";?>'>
					  <label for="answerText3" class="col-sm-2 control-label">Answer Text:</label>
					  <div class="col-sm-10">
					  <textarea class="form-control" id="answerText3" name="answerText3" rows="5" cols="80" placeholder="Answer text"><?php echo $answerOpt3Text; ?></textarea>	
					  </div>
					</div>
					
					<!--Answer icon-->
					<div class="form-group" id="divAnswerIcon3" style='<?php echo "$answerOpIcon3";?>'>
					  ...
					  <img src='<?php echo "$answerOpt3Icon";?>' class='myImg' id="outputAnswerIcon3" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<!--Answer icon-->
					<div class="form-group" id="divAnswerPic3" style='<?php echo "$answerOpPic3";?>'>
					  ...
					  <img src='<?php echo "$answerOpt3Pic";?>' class='myImg' id="outputAnswerPic3" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<div class="box-footer" align="right">
						<input type='text' id="addQuestion4" style="display: none" class="btn btn-primary" style="padding: 0; border: none; background: none;color:blue;" value='+ ADD ANSWER OPTION' readonly>
					</div>
				...
				Answer Option 4
					<div class="form-group" id="divAnswerText4" style='<?php echo "$answerOpText4";?>'>
					  <label for="answerText4" class="col-sm-2 control-label">Answer Text:</label>
					  <div class="col-sm-10">
					  <textarea class="form-control" id="answerText4" name="answerText4" rows="5" cols="80" placeholder="Answer text"><?php echo $answerOpt4Text; ?></textarea>	
					  </div>
					</div>
					
					<!--Answer icon-->
					<div class="form-group" id="divAnswerIcon4" style='<?php echo "$answerOpIcon4";?>'>
					  ...
					  <img src='<?php echo "$answerOpt4Icon";?>' class='myImg' id="outputAnswerIcon4" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<!--Answer icon-->
					<div class="form-group" id="divAnswerPic4" style='<?php echo "$answerOpPic4";?>'>
					  ...
					  <img src='<?php echo "$answerOpt4Pic";?>' class='myImg' id="outputAnswerPic4" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<div class="box-footer" align="right">
					<input type='text' id="addQuestion5" style="display: none" class="btn btn-primary" style="padding: 0; border: none; background: none;color:blue;" value='+ ADD ANSWER OPTION' readonly>
				</div>
				</div>
				...
				Answer Option 5
					<div class="form-group" id="divAnswerText5" style='<?php echo "$answerOpIcon5";?>'>
					  <label for="answerText5" class="col-sm-2 control-label">Answer Text:</label>
					  <div class="col-sm-10">
					  <textarea class="form-control" id="answerText5" name="answerText5" rows="5" cols="80" placeholder="Answer text"><?php echo $answerOpt5Text; ?></textarea>	
					  </div>
					</div>
					
					<!--Answer icon-->
					<div class="form-group" id="divAnswerIcon5" style='<?php echo "$answerOpIcon5";?>'>
					  ...
					  <img src='<?php echo "$answerOpt5Icon";?>' class='myImg' id="outputAnswerIcon5" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
					...
					<!--Answer icon-->
					<div class="form-group" id="divAnswerPic5" style='<?php echo "$answerOpPic5";?>'>
					  ...
					  <img src='<?php echo "$answerOpt5Pic";?>' class='myImg' id="outputAnswerPic5" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
			  ...
			  <div class="tab-pane" id="solutionInfo">
                ...
                <label for="status" class="col-sm-2 control-label">Correct Answer Option:</label>
				  <div class="col-sm-10" required>
					<select class="form-control select2" name="correctAnswerOption" id="correctAnswerOption" style="width: 100%;">
					  <option selected="selected" disabled>--Select--</option>
					  <option value="1" <?php echo (($correctAnswerOption=="1")?'selected="selected"':"");?>>1. Option A</option>
					  <option value="2" <?php echo (($correctAnswerOption=="2")?'selected="selected"':"");?>>2. Option B</option>
					  <option value="3" <?php echo (($correctAnswerOption=="3")?'selected="selected"':"");?>>3. Option C</option>
					  <option value="4" <?php echo (($correctAnswerOption=="4")?'selected="selected"':"");?>>4. Option D</option>
					</select>			  
				  </div>
				</div>
					...
					<div class="form-group">
					  ...
					  <img src='<?php echo "$solutionPic";?>' class='myImg' id="outputSolutionImage" style="margin-top: 10px;" width='100' height='100'/>
					  <!-- The Modal -->
						<div id='myModal' class='modal'>
						<!-- The Close Button -->
						<span class='close'>&times;</span>
			...
			<script>
			  ...
			  <div class="tab-pane" id="preview">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  <div id="questionText_1"><?php echo $questionText; ?></div>
				  </div>
                </div>
				...
				<label for="outputQuestionPic1" class="col-sm-2 control-label"></label>
				  <div class="col-sm-10">
				  <img src='<?php echo "$questionPic";?>' style="display:none;" id="outputQuestionPic1" style="margin-top: 10px;" width='100' height='100'/>
					<div id='myModal' class='modal'>
					<!-- The Close Button -->
					<span class='close'>&times;</span>
					<!-- Modal Content (The Image) -->
				...
				<div class="form-group" id="divAnswerText1_1">
				  ...
				  <div class="col-sm-10">
				  <div id="answerText1_1"><?php echo $answerOpt1Text; ?></div>
				  </div>
                </div>
				...
				<div class="form-group" id="divAnswerPic1_1">
                  ...
                  <img src='<?php echo "$answerOpt1Pic";?>' style='display:none;' id="outputAnswerPic1_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerIcon1_1">
				  ...
				  <img src='<?php echo "$answerOpt1Icon";?>' style='display:none;' id="outputAnswerIcon1_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerText2_1">
				  ...
				  <div class="col-sm-10">
				  <div id="answerText2_1"><?php echo $answerOpt2Text; ?></div>
				  </div>
                </div>
				...
				<div class="form-group" id="divAnswerPic2_1">
				  ...
				  <div class="col-sm-10">
                  <img src='<?php echo "$answerOpt2Pic";?>' style='display:none;' id="outputAnswerPic2_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerIcon2_1">
				  ...
				  <div class="col-sm-10">
					<img src='<?php echo "$answerOpt2Icon";?>' style='display:none;' id="outputAnswerIcon2_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerText3_1">
				  ...
				  <div class="col-sm-10">
				  <div id="answerText3_1"><?php echo $answerOpt3Text; ?></div>
				  </div>
                </div>
				...
				<div class="form-group" id="divAnswerPic3_1">
				  ...
				  <div class="col-sm-10">
                  <img src='<?php echo "$answerOpt3Pic";?>' style='display:none;' id="outputAnswerPic3_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerIcon3_1">
				  ...
				  <div class="col-sm-10">
					<img src='<?php echo "$answerOpt3Icon";?>' style='display:none;' id="outputAnswerIcon3_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerText4_1">
				  ...
				  <div class="col-sm-10">
				  <div id="answerText4_1"><?php echo $answerOpt4Text; ?></div>
				  </div>
                </div>
				...
				<div class="form-group" id="divAnswerPic4_1">
				  ...
				  <div class="col-sm-10">
                  <img src='<?php echo "$answerOpt4Pic";?>' style='display:none;' id="outputAnswerPic4_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerIcon4_1">
				  ...
				  <div class="col-sm-10">
					<img src='<?php echo "$answerOpt4Icon";?>' style='display:none;' id="outputAnswerIcon4_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerText5_1">
				  ...
				  <div class="col-sm-10">
				  <div id="answerText5_1"><?php echo $answerOpt5Text; ?></div>
				  </div>
                </div>
				...
				<div class="form-group" id="divAnswerPic5_1">
				  ...
				  <div class="col-sm-10">
                  <img src='<?php echo "$answerOpt5Pic";?>' style='display:none;' id="outputAnswerPic5_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
				...
				<div class="form-group" id="divAnswerIcon5_1">
				  ...
				  <div class="col-sm-10">
					<img src='<?php echo "$answerOpt5Pic";?>' style='display:none;' id="outputAnswerIcon5_1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
			...
			<h4 class="box-title">Solution Details</h4>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
                  <label id="correctAnsOption_1" style="font-weight:normal;margin-top:5px;"><?php echo $correctAnswerOption; ?></label>
				  </div>
                </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  <div id="solutionText_1"><?php echo $solutionText; ?></div>
				  </div>
                </div>
				...
				<label for="outputSolutionImage1" class="col-sm-2 control-label"></label>
				  <div class="col-sm-10">
                  <img src='<?php echo "$solutionPic";?>' style='display:none;' id="outputSolutionImage1" class='myImg' style="margin-top: 10px;" width='100' height='100'/>
...
{
	var focusSet = false;
    if (!$('#correctAnswerOption').val()) 
	{
        if ($("#correctAnswerOption").parent().next(".validation").length == 0) // only add if not added
        {
            $("#correctAnswerOption").parent().after("<div class='validation' style='color:red;margin-bottom: 20px;'>Please enter correct answer option!</div>");
        }
        e.preventDefault(); // prevent form from POST to server
        $('#correctAnswerOption').focus();
        focusSet = true;
    } else {
        $("#correctAnswerOption").parent().next(".validation").remove(); // remove it
		...
		let correctAnsOption = document.getElementById('correctAnswerOption').value;
...
//for adding/removing options 
 $(document).ready(function(){
  ...
  $("#removeQuestion1").click(function(){
    ...
    $("#dvAnsOp1_1").hide();
    //$("#addQuestion1").show();
	$('#addQuestion1').css({'display':'block'});	
...
//for image preview
  ...
  var loadFileQuestionPic2 = function(event) {
    var reader = new FileReader();
    reader.onload = function(){
      var output = document.getElementById('outputQuestionPic2');
      var output1 = document.getElementById('outputQuestionPic2_1');
      output.src = reader.result;
      output1.src = reader.result;
	  $("#outputQuestionPic2").show();
	  $("#outputQuestionPic2_1").show();
    };
    reader.readAsDataURL(event.target.files[0]);
  };
  ...
  var loadFileQuestionPic3 = function(event) {
    var reader = new FileReader();
    reader.onload = function(){
      var output = document.getElementById('outputQuestionPic3');
      var output1 = document.getElementById('outputQuestionPic3_1');
      output.src = reader.result;
      output1.src = reader.result;
	  $("#outputQuestionPic3").show();
	  $("#outputQuestionPic3_1").show();
    };
    reader.readAsDataURL(event.target.files[0]);
  };
  ...
  var loadFileAnswerPic3 = function(event) {
    ...
    reader.onload = function(){
      ...
      var output = document.getElementById('outputAnswerPic3_1');
      output.src = reader.result;
      output1.src = reader.result;
  ...
  var loadFileQuestionPic4 = function(event) {
    var reader = new FileReader();
    reader.onload = function(){
      var output = document.getElementById('outputQuestionPic4');
      var output1 = document.getElementById('outputQuestionPic4_1');
      output.src = reader.result;
      output1.src = reader.result;
	  $("#outputQuestionPic4").show();
	  $("#outputQuestionPic4_1").show();
    };
    reader.readAsDataURL(event.target.files[0]);
  };
  ...
  var loadFileQuestionPic5 = function(event) {
    var reader = new FileReader();
    reader.onload = function(){
      var output = document.getElementById('outputQuestionPic5');
      var output1 = document.getElementById('outputQuestionPic5_1');
      output.src = reader.result;
      output1.src = reader.result;
	  $("#outputQuestionPic5").show();
	  $("#outputQuestionPic5_1").show();
    };
    reader.readAsDataURL(event.target.files[0]);
  };
